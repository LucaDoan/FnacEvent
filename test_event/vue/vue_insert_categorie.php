<h3 style="text-align: center;"> Ajout d'une categorie</h3>
        ...
        <table style="border: 1px solid lightgray; border-radius: 10px; padding: 20px;">
            ...
            <td><input type="text" placeholder="Entrez un libelle" name="libelle" style="width: 100%; padding: 10px; font-size: 16px; border-radius: 5px; border: 1px solid lightgray;" /></td>
            </tr>
            <tr>
            <td></td>
